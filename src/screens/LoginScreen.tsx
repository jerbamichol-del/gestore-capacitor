    ...
    if (!activeEmail) {
      return (
        <div className="text-center">
          <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-2">Bentornato!</h2>
          <p className="text-slate-500 dark:text-slate-400 mb-6">Inserisci la tua email per continuare.</p>
