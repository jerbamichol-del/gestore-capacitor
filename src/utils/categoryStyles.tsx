...
// Mappa dei colori di SFONDO reali delle icone (estratti dagli SVG)
export const ICON_BG_COLORS: Record<string, string> = {
    ...
    'charity': '#EAAC2E',
    'other': '#B49A85',
    // Fallback generici per icone specifiche
    'gift': '#EC4899', // Pink
    'travel': '#0EA5E9', // Sky
...
export const ICON_MAP: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    'all': AllIcon,
    // ... finanza/svago/shopping/alimentari/salute/istruzione/trasporti omitted for brevity but they exist in original file
    'finanza1': Finanza1Icon, 'finanza2': Finanza2Icon, 'finanza3': Finanza3Icon, 'finanza4': Finanza4Icon,
    'finanza5': Finanza5Icon, 'finanza6': Finanza6Icon, 'finanza7': Finanza7Icon, 'finanza8': Finanza8Icon,
    'finanza9': Finanza9Icon, 'finanza10': Finanza10Icon, 'finanza11': Finanza11Icon, 'finanza12': Finanza12Icon,
    'finanza13': Finanza13Icon, 'finanza14': Finanza14Icon, 'finanza15': Finanza15Icon, 'finanza16': Finanza16Icon,
    'svago1': Svago1Icon, 'svago2': Svago2Icon, 'svago3': Svago3Icon, 'svago4': Svago4Icon,
    'svago5': Svago5Icon, 'svago6': Svago6Icon, 'svago7': Svago7Icon, 'svago8': Svago8Icon,
    'svago9': Svago9Icon, 'svago10': Svago10Icon, 'svago11': Svago11Icon, 'svago12': Svago12Icon,
    'svago13': Svago13Icon, 'svago14': Svago14Icon, 'svago15': Svago15Icon, 'svago16': Svago16Icon,
    'svago17': Svago17Icon, 'svago18': Svago18Icon, 'svago19': Svago19Icon, 'svago20': Svago20Icon,
    'svago21': Svago21Icon, 'svago22': Svago22Icon, 'svago23': Svago23Icon, 'svago24': Svago24Icon,
    'svago25': Svago25Icon, 'svago26': Svago26Icon,
    'shopping1': Shopping1Icon, 'shopping2': Shopping2Icon, 'shopping3': Shopping3Icon, 'shopping4': Shopping4Icon,
    'shopping5': Shopping5Icon, 'shopping6': Shopping6Icon, 'shopping7': Shopping7Icon, 'shopping8': Shopping8Icon,
    'shopping9': Shopping9Icon, 'shopping10': Shopping10Icon, 'shopping11': Shopping11Icon, 'shopping12': Shopping12Icon,
    'shopping13': Shopping13Icon, 'shopping14': Shopping14Icon, 'shopping15': Shopping15Icon, 'shopping16': Shopping16Icon,
    'shopping17': Shopping17Icon, 'shopping18': Shopping18Icon, 'shopping19': Shopping19Icon, 'shopping20': Shopping20Icon,
    'alimentari1': Alimentari1Icon, 'alimentari2': Alimentari2Icon, 'alimentari3': Alimentari3Icon, 'alimentari4': Alimentari4Icon,
    'alimentari5': Alimentari5Icon, 'alimentari6': Alimentari6Icon, 'alimentari7': Alimentari7Icon, 'alimentari8': Alimentari8Icon,
    'alimentari9': Alimentari9Icon, 'alimentari22': Alimentari22Icon, 'alimentari23': Alimentari23Icon, 'alimentari24': Alimentari24Icon,
    'alimentari25': Alimentari25Icon, 'alimentari26': Alimentari26Icon, 'alimentari27': Alimentari27Icon, 'alimentari28': Alimentari28Icon,
    'alimentari29': Alimentari29Icon, 'alimentari30': Alimentari30Icon, 'alimentari31': Alimentari31Icon, 'alimentari32': Alimentari32Icon,
    'alimentari33': Alimentari33Icon, 'alimentari34': Alimentari34Icon, 'alimentari35': Alimentari35Icon, 'alimentari36': Alimentari36Icon,
    'alimentari37': Alimentari37Icon,
    'salute1': Salute1Icon, 'salute2': Salute2Icon, 'salute3': Salute3Icon, 'salute4': Salute4Icon,
    'salute5': Salute5Icon, 'salute6': Salute6Icon, 'salute7': Salute7Icon, 'salute8': Salute8Icon,
    'salute9': Salute9Icon, 'salute10': Salute10Icon, 'salute11': Salute11Icon, 'salute12': Salute12Icon,
    'salute13': Salute13Icon, 'salute14': Salute14Icon, 'salute15': Salute15Icon, 'salute16': Salute16Icon,
    'salute17': Salute17Icon, 'salute18': Salute18Icon, 'salute19': Salute19Icon, 'salute20': Salute20Icon,
    'istruzione1': Istruzione1Icon, 'istruzione2': Istruzione2Icon, 'istruzione3': Istruzione3Icon, 'istruzione4': Istruzione4Icon,
    'istruzione5': Istruzione5Icon, 'istruzione6': Istruzione6Icon, 'istruzione7': Istruzione7Icon, 'istruzione8': Istruzione8Icon,
    'istruzione9': Istruzione9Icon, 'istruzione10': Istruzione10Icon, 'istruzione11': Istruzione11Icon, 'istruzione12': Istruzione12Icon,
    'istruzione13': Istruzione13Icon, 'istruzione14': Istruzione14Icon, 'istruzione15': Istruzione15Icon, 'istruzione16': Istruzione16Icon,
    'trasporti1': Trasporti1Icon, 'trasporti2': Trasporti2Icon, 'trasporti3': Trasporti3Icon, 'trasporti4': Trasporti4Icon,
    'trasporti5': Trasporti5Icon, 'trasporti6': Trasporti6Icon, 'trasporti7': Trasporti7Icon, 'trasporti8': Trasporti8Icon,
    'trasporti9': Trasporti9Icon, 'trasporti10': Trasporti10Icon, 'trasporti11': Trasporti11Icon, 'trasporti12': Trasporti12Icon,
    'trasporti13': Trasporti13Icon, 'trasporti14': Trasporti14Icon, 'trasporti15': Trasporti15Icon, 'trasporti16': Trasporti16Icon
};

// Legacy styles map (keep for backward compatibility if needed)
export const categoryStyles: Record<string, CategoryStyle> = {
    'all': { label: 'Tutte', Icon: AllIcon, color: 'text-slate-600', bgColor: 'bg-slate-200', iconId: 'all' },
    'Alimentari': { label: 'Alimentari', Icon: FoodIcon, color: 'text-lime-600', bgColor: 'bg-lime-100', iconId: 'food' },
    'Trasporti': { label: 'Trasporti', Icon: TransportIcon, color: 'text-slate-600', bgColor: 'bg-slate-100', iconId: 'transport' },
    'Casa': { label: 'Casa', Icon: HomeIcon, color: 'text-blue-900', bgColor: 'bg-blue-100', iconId: 'home' },
    'Shopping': { label: 'Shopping', Icon: ShoppingIcon, color: 'text-purple-600', bgColor: 'bg-purple-100', iconId: 'shopping' },
    'Tempo Libero': { label: 'Tempo Libero', Icon: LeisureIcon, color: 'text-yellow-600', bgColor: 'bg-yellow-100', iconId: 'leisure' },
    'Salute': { label: 'Salute', Icon: HealthIcon, color: 'text-cyan-600', bgColor: 'bg-cyan-100', iconId: 'health' },
    'Istruzione': { label: 'Istruzione', Icon: EducationIcon, color: 'text-green-600', bgColor: 'bg-green-100', iconId: 'education' },
    'Lavoro': { label: 'Lavoro', Icon: WorkIcon, color: 'text-blue-600', bgColor: 'bg-blue-100', iconId: 'work' },
    'Beneficienza': { label: 'Beneficienza', Icon: CharityIcon, color: 'text-red-600', bgColor: 'bg-red-100', iconId: 'charity' },
    'Altro': { label: 'Altro', Icon: OtherIcon, color: 'text-amber-900', bgColor: 'bg-amber-100', iconId: 'other' },
};
...
export const getCategoryStyle = (category: string | 'all'): CategoryStyle => {
    ...
    if (customCat) {
        ...
        return {
            ...
            iconId: customCat.icon // Pass iconId for pie chart color matching
        };
    }
