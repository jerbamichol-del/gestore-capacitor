      ...
      >
        ...
        <div className="p-4">
          ...
          <div className="space-y-4">
            ...
            {activeTab === 'yearly' && (
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Seleziona Anno</label>
                ...
                <div className="flex gap-2 items-center">
                  <button
                    ...
                    className="p-3 bg-sunset-peach/30 dark:bg-midnight-card/50 rounded-lg font-bold text-slate-600 dark:text-slate-300 hover:bg-sunset-peach/50 dark:hover:bg-midnight-card transition-colors"
                  >-</button>
                  <div className="flex-1 text-center p-3 bg-sunset-cream/60 dark:bg-midnight-card/50 border border-slate-300 dark:border-electric-violet/30 rounded-xl font-bold text-lg text-slate-800 dark:text-white">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-electric-violet/20 flex justify-end">
          <button
            onClick={handleApply}
