    ...
    return (
        ...
        >
            ...
            <button
                ...
                className={`pointer-events-auto flex justify-center items-center w-16 h-16 bg-indigo-600 dark:btn-electric text-white rounded-full shadow-lg hover:bg-indigo-700 transition-all transform duration-500 ease-in-out focus:outline-none dark:shadow-electric-violet/20 ${isMounted ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-16 scale-90'}`}
