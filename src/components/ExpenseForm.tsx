      ...
      <div className={`fixed inset-0 z-[5000] transition-opacity duration-300 ease-in-out ${isAnimating ? 'opacity-100' : 'opacity-0'} bg-slate-900/80 backdrop-blur-md`} onClick={handleBackdropClick} aria-modal="true" role="dialog">
        ...
        {isRecurrenceModalOpen && (
          <div className={`fixed inset-0 z-[60] flex justify-center items-center p-4 transition-opacity duration-300 ease-in-out ${isRecurrenceModalAnimating ? 'opacity-100' : 'opacity-0'} bg-slate-900/80 backdrop-blur-md`} onClick={handleCloseRecurrenceModal} aria-modal="true" role="dialog">
            <div className={`bg-white midnight-card rounded-lg shadow-xl w-full max-w-sm border border-slate-200 dark:border-electric-violet/30 transform transition-all duration-300 ease-in-out ${isRecurrenceModalAnimating ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`} onClick={(e) => e.stopPropagation()}>
        ...
        {isReceiptMenuOpen && (
          <div className={`fixed inset-0 z-[5200] flex justify-center items-center p-4 bg-midnight/80 backdrop-blur-md transition-opacity duration-300 ease-in-out ${isReceiptMenuAnimating ? 'opacity-100' : 'opacity-0'}`} onClick={handleCloseReceiptMenu}>
            <div className="bg-slate-50 midnight-card rounded-lg shadow-xl w-full max-w-sm border border-slate-200 dark:border-electric-violet/30" onClick={(e) => e.stopPropagation()}>
