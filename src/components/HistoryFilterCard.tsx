...
export const CustomDateRangeInputs: React.FC<{
  ...
  return (
    <div
      className={
        `w-full ${compact ? 'h-8' : 'h-10'} flex border rounded-lg overflow-hidden transition-colors relative border-sunset-pink/20 dark:border-electric-violet/50 bg-[#9AE6B4] dark:bg-electric-violet/20`
      }
    >
    ...
    return (
      ...
      >
        ...
        <button
          ...
          type="button"
          className={
            `flex-1 h-full text-sm font-semibold bg-[#9AE6B4] dark:bg-electric-violet/20 text-black dark:text-electric-violet ` +
            (compact ? '' : ' hover:bg-[#68D391] dark:hover:bg-electric-violet/30 transition-colors')
          }
          data-no-drag
          {...tapBridge}
        >
