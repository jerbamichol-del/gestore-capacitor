...
export const CustomDateRangeInputs: React.FC<{
  ...
  return (
    <div
      className={
        `w-full ${compact ? 'h-8' : 'h-10'} flex border rounded-lg overflow-hidden transition-colors relative border-sunset-pink/20 dark:border-electric-violet/50 bg-sunset-peach dark:bg-electric-violet/20`
      }
    >
      ...
      >
        ...
        <button
          ...
          className={
            ...
            (compact ? '' : ' hover:bg-sunset-peach/80 dark:hover:bg-electric-violet/30 transition-colors')
          }
          data-no-drag
          {...tapBridge}
        >
