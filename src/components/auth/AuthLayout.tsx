...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  ...
  return (
    <div
      ...
      className="bg-sunset-cream dark:bg-midnight font-sans flex flex-col p-4 overflow-auto overflow-x-hidden touch-manipulation transition-colors duration-300"
    >
